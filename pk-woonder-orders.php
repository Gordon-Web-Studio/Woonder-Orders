 ...
 */
define( 'PK_WOONDER_ORDERS_VERSION', '1.0.0' );
...
register_deactivation_hook( __FILE__, 'deactivate_pk_woonder_orders' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-pk-woonder-orders.php';
